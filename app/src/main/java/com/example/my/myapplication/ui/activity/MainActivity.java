...
import com.example.my.myapplication.IOT.map.mapClickDetail.TestMapFragments;
...
public class MainActivity extends NavigationLiveo implements OnItemClickListener {
    ...
    public void onInt(Bundle savedInstanceState) {
        ...
        with(this).startingPosition(3) //Starting position in the list
    ...
    public void onItemClick(int position) {
        ...
        switch (position) {
            ...
            case 2:
                ...
                break;
            case 3:
                mFragment = new TestMapFragments();
