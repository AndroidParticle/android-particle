    ...
    public void rebuildSpeedDialMenu() {
        ...
        for (int i = menuAdapter.getCount() - 1; i >= 0; --i) {
            ...
            view.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    // Toast.makeText(getContext(),"rebuildSpeedDialMenu", Toast.LENGTH_SHORT).show();;
...
//			});
    ...
    private void toggleSpeedDialMenu() {
        ...
        if (!speedDialMenuOpen && speedDialCloseListener != null)
            speedDialCloseListener.onClose(this);
    ...
    private void toggleFabIconForSpeedDialMenu(boolean visible) {
        ...
        iconContainer.animate()
                ...
                .setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        //   Toast.makeText(getContext(),"toggleFab", Toast.LENGTH_SHORT).show();;
    ...
    private void setSpeedDialCoverVisible(boolean visible) {
        ...
        coverView.animate()
                ...
                .setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        // Toast.makeText(getContext(),"setSpeedDialCoverVisible", Toast.LENGTH_SHORT).show();;
        ...
        for (int i = 0, n = speedDialMenuItems.size(); i < n; ++i) {
            ...
            v.animate()
                    ...
                    .setListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            //    Toast.makeText(getContext(),"setSpeedDialMenuVisible", Toast.LENGTH_SHORT).show();;
