package com.example.my.myapplication.IOT.map.mapapidirection;
...
public class MapseActivity extends Fragment implements OnMapReadyCallback,
...
// https://maps.googleapis.com/maps/api/directions/json?origin=10.934842799001613,106.8701995164156&destination=10.913661383847856,106.85692191123962&sensor=false
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            PolylineOptions lineOptions = null;//vẽ đường đi
